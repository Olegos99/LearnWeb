function DarkMode() {
    ...
    if (color === "black") {
        document.body.style.background = "#1e1e1e url('images/night.jpg') no-repeat right top"; 
        ...
        document.body.style.background = "#1e1e1e url('images/day.jpg') no-repeat right top"; 
